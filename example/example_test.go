...
func Example_dataloader() {
	...
	thunk1 := sitesDataloader.LoadThunk("shippers/folkfood", "shippers/folkfood/sites/sthlm")
	thunk2 := sitesDataloader.LoadThunk("shippers/folkfood", "shippers/folkfood/sites/gbg")
